...
void LineListMarker::reset()
{
  marker_.points.clear();
}

void LineListMarker::setColor(double color[3])
{
  marker_.color.r = color[0];
  marker_.color.g = color[1];
  marker_.color.b = color[2];
...
void LineListMarker::setPose(const Eigen::VectorXd& position)
{
